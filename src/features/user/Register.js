...
function Register(){
    ...
    const submitForm = (e) =>{
        ...
        if(registerObj.name.trim() === "")return setErrorMessage("Business Name is required!")
        if(registerObj.bsnlogo.trim() === "")return setErrorMessage("Business Logo is required!")
            ...
            <div className="card mx-auto w-full max-w-5xl  shadow-xl">
                ...
                <div className='py-24 px-10'>
                    ...
                    <form onSubmit={(e) => submitForm(e)}>
                        ...
                        <div className="mb-4">
                              <InputText defaultValue={registerObj.name} updateType="name" containerStyle="mt-4" labelTitle="Business Name" updateFormValue={updateFormValue}/>


                            <InputText defaultValue={registerObj.phonenumber} updateType="Phone Number" containerStyle="mt-4" labelTitle="Phone Number" updateFormValue={updateFormValue}/>


                            <InputText defaultValue={registerObj.bsnlogo} updateType="name" containerStyle="mt-4" labelTitle="Business Logo" updateFormValue={updateFormValue}/>
